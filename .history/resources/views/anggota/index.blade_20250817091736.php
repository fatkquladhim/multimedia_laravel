                ...
                @if (isset($divisiList[0]))
                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-white border-0">
                            <h5 class="fw-bold mb-0"><i class="fa fa-users text-primary"></i> Data Anggota
                                {{ ucfirst($divisiList[0]) }}</h5>
                        </div>
                        <div class="card-body">
                                                    ...
                                                    <div class="form-button-action">
                                                        ...
                                                        <form action="{{ route('anggota.destroy', $item->id) }}"
                                                            ...
                                                            <button type="submit" class="btn btn-link btn-danger"
                                                                onclick="return confirm('Yakin hapus?')"><i class="fa fa-times"></i></button>
                                                        </form>
                                                    </div>
                                                </td>
                                            </tr>
