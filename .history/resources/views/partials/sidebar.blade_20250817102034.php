              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="charts">
                  <ul class="nav nav-collapse">
                    ...
                    <li>
                      <form action="{{ route('logout') }}" method="POST" class="sub-item">
                        @csrf
                        <button type="submit" class="" style="background:none;border:none;padding:0;margin:0;cursor:pointer;">logout</button>
                      </form>
                    </li>
                  </ul>
                </div>
