               ...
               <!-- Welcome Section -->
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-8">
                    ...
                    <a href="anggota/anggota.php" class="block">
                        <div
                            class="bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm hover-scale animate-fade-in cursor-pointer">
                            <div class="flex items-center justify-between">
                                ...
                                <div
                                    class="w-12 h-12 bg-light-blue-100 dark:bg-light-blue-900 rounded-lg flex items-center justify-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mb-4">
                    ...
                    <div
                        class="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm animate-fade-in flex flex-col h-full">
                        <div class="flex items-center justify-between mb-4">
                            <h2 class="text-xl md:text-2xl font-bold text-gray-800 dark:text-white">Tugas yang Belum
                                Dikerjakan</h2>
                            <a href="beri tugas/tugas_belum_dikerjakan.php"
                                class="text-light-blue-500 hover:text-light-blue-600 dark:text-light-blue-400 dark:hover:text-light-blue-300 font-medium">View
                                All</a>
                        </div>
                        <div class="flex-1 flex flex-col justify-between">
                            <div class="space-y-2">
                                ...
                                <div
                                    class="flex items-center p-3 bg-light-blue-50 dark:bg-light-blue-900 rounded-xl hover-scale justify-between">
                                    <div>
                                    ...
                                    <button
                                        class="ml-4 px-3 py-1 bg-light-blue-600 hover:bg-light-blue-700 text-white rounded text-xs font-medium transition-colors detail-tugas-btn"
                                        data-nama="Desain Poster Acara"
                                        data-deskripsi="Buat desain poster untuk acara tahunan." data-username="user1"
                                        data-status="Belum Dikerjakan">Detail</button>
                                </div>
                                ...
                                <div
                                    ...
                                    <button
                                        ...
                                        data-username="user2" data-status="Belum Dikerjakan">Detail</button>
                                </div>
                                ...
                                <div
                                    ...
                                    <button
                                        ...
                                        data-username="user3" data-status="Belum Dikerjakan">Detail</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm animate-fade-in flex flex-col h-full">
                        <div class="flex items-center justify-between mb-4">
                            <h2 class="text-xl md:text-2xl font-bold text-gray-800 dark:text-white">Riwayat Tugas
                                Selesai</h2>
                            <a href="beri tugas/tugas_selesai_riwayat.php"
                                class="text-light-blue-500 hover:text-light-blue-600 dark:text-light-blue-400 dark:hover:text-light-blue-300 font-medium">
                                View All</a>
                        </div>
                        <div class="flex-1 flex flex-col justify-between">
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center p-3 bg-green-50 dark:bg-green-900 rounded-xl hover-scale justify-between detail-tugas-selesai-btn"
                                    tabindex="0" data-nama="Riset Tren Desain"
                                    data-deskripsi="Melakukan riset tren desain grafis terbaru." data-username="user4"
                                    data-status="Selesai" data-tanggal="01 Jan 2024 10:30">
                                    <div>
                                        <span class="font-medium text-gray-800 dark:text-white">
                                            Riset Tren Desain
                                        </span>
                                ...
                                <div class="flex items-center p-3 bg-green-50 dark:bg-green-900 rounded-xl hover-scale justify-between detail-tugas-selesai-btn"
                                    tabindex="0" data-nama="Setup Peralatan Audio"
                                    data-deskripsi="Menyiapkan peralatan audio untuk rekaman podcast."
                                    data-username="user5" data-status="Selesai" data-tanggal="31 Dec 2023 15:00">
                                    <div>
                                        <span class="font-medium text-gray-800 dark:text-white">
                                ...
                                <div class="flex items-center p-3 bg-green-50 dark:bg-green-900 rounded-xl hover-scale justify-between detail-tugas-selesai-btn"
                                    tabindex="0" data-nama="Fotografi Acara Kampus"
                                    data-deskripsi="Mengambil foto-foto di acara kampus." data-username="user6"
                                    data-status="Selesai" data-tanggal="30 Dec 2023 18:45">
                                    <div>
                                        <span class="font-medium text-gray-800 dark:text-white">
                                ...
                                <div class="flex items-center p-3 bg-green-50 dark:bg-green-900 rounded-xl hover-scale justify-between detail-tugas-selesai-btn"
                                    tabindex="0" data-nama="Review Artikel Jurnalistik"
                                    data-deskripsi="Review dan koreksi artikel jurnalistik sebelum publikasi."
                                    data-username="user7" data-status="Selesai" data-tanggal="29 Dec 2023 11:00">
                                    <div>
                                        <span class="font-medium text-gray-800 dark:text-white">
                                ...
                                <div class="flex items-center p-3 bg-green-50 dark:bg-green-900 rounded-xl hover-scale justify-between detail-tugas-selesai-btn"
                                    tabindex="0" data-nama="Pengembangan Website Divisi"
                                    data-deskripsi="Melanjutkan pengembangan fitur baru untuk website divisi."
                                    data-username="user8" data-status="Selesai" data-tanggal="28 Dec 2023 09:15">
                                    <div>
                                        <span class="font-medium text-gray-800 dark:text-white">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-xl p-4 md:p-6 shadow-sm animate-fade-in">
                        <h3 class="text-lg md:text-xl font-bold text-gray-800 dark:text-white mb-6">Anggota yang Izin
                            Malam</h3>
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start justify-between p-4 bg-light-blue-50 dark:bg-light-blue-900 rounded-xl hover-scale anggota-izin-btn"
                                data-nama="Budi Santoso" data-tanggal="01 Jan 2024" data-jam_izin="22:00"
                                data-jam_selesai_izin="05:00" data-alasan="Acara keluarga">
                                <div class="flex items-start space-x-3">
                                    <div class="flex gap-10">
                                        <h4 class="font-semibold text-gray-800 dark:text-white text-xs"> Nama:<br><span
                                                class="text-xs">Budi Santoso</span></h4>
                            ...
                            <div class="flex items-start justify-between p-4 bg-light-blue-50 dark:bg-light-blue-900 rounded-xl hover-scale anggota-izin-btn"
                                data-nama="Siti Aminah" data-tanggal="02 Jan 2024" data-jam_izin="23:00"
                                data-jam_selesai_izin="06:00" data-alasan="Sakit">
                                <div class="flex items-start space-x-3">
                                    <div class="flex gap-10">
                                        <h4 class="font-semibold text-gray-800 dark:text-white text-xs"> Nama:<br><span
                                                class="text-xs">Siti Aminah</span></h4>
                                        <div class="flex gap-4 flex-wrap">
                                            <h4 class="font-semibold text-gray-800 dark:text-white text-xs">
                            ...
                            <div class="flex items-start justify-between p-4 bg-light-blue-50 dark:bg-light-blue-900 rounded-xl hover-scale anggota-izin-btn"
                                data-nama="Joko Susilo" data-tanggal="03 Jan 2024" data-jam_izin="21:30"
                                data-jam_selesai_izin="04:30" data-alasan="Ada keperluan mendadak">
                                <div class="flex items-start space-x-3">
                                    <div class="flex gap-10">
                                        <h4 class="font-semibold text-gray-800 dark:text-white text-xs"> Nama:<br><span
                                                class="text-xs">Joko Susilo</span></h4>
                                        <div class="flex gap-4 flex-wrap">
                                            <h4 class="font-semibold text-gray-800 dark:text-white text-xs">
                            ...
                            <div class="flex items-start justify-between p-4 bg-light-blue-50 dark:bg-light-blue-900 rounded-xl hover-scale anggota-izin-btn"
                                data-nama="Dewi Lestari" data-tanggal="04 Jan 2024" data-jam_izin="22:45"
                                data-jam_selesai_izin="05:30" data-alasan="Pulang kampung">
                                <div class="flex items-start space-x-3">
                                    <div class="flex gap-10">
                                        <h4 class="font-semibold text-gray-800 dark:text-white text-xs"> Nama:<br><span
                                                class="text-xs">Dewi Lestari</span></h4>
                                        <div class="flex gap-4 flex-wrap">
                                            <h4 class="font-semibold text-gray-800 dark:text-white text-xs">
                    ...
                    <!-- Bagian User Online -->
                    <div class="bg-white dark:bg-slate-800 rounded-xl p-4 md:p-6 shadow-sm animate-fade-in">
                        <h3 class="text-lg md:text-xl font-bold text-gray-800 dark:text-white mb-6">User yang Online
                        </h3>
                        <div class="space-y-2">

                            <div class="flex items-center p-3 bg-green-50 dark:bg-green-900 rounded-xl hover-scale cursor-pointer user-info-btn"
                                data-nama="user1" data-email="user1@example.com" data-role="USER"
                                data-nama_lengkap="User Satu" data-foto="user1.jpg">
                            ...
                            <div class="flex items-center p-3 bg-green-50 dark:bg-green-900 rounded-xl hover-scale cursor-pointer user-info-btn"
                                data-nama="user2" data-email="user2@example.com" data-role="USER"
                                data-nama_lengkap="User Dua" data-foto="user2.jpg">
                                <i class="fas fa-circle text-green-500 text-xs mr-2"></i>
                                <span class="font-medium text-gray-800 dark:text-white">
                                    user2
                                    (USER)
                            ...
                            <div class="flex items-center p-3 bg-green-50 dark:bg-green-900 rounded-xl hover-scale cursor-pointer user-info-btn"
                                data-nama="user3" data-email="user3@example.com" data-role="USER"
                                data-nama_lengkap="User Tiga" data-foto="user3.jpg">
                                <i class="fas fa-circle text-green-500 text-xs mr-2"></i>
                                <span class="font-medium text-gray-800 dark:text-white">
                                    user3
                                    (USER)
                            ...
                            <div class="flex items-center p-3 bg-green-50 dark:bg-green-900 rounded-xl hover-scale cursor-pointer user-info-btn"
                                data-nama="user4" data-email="user4@example.com" data-role="USER"
                                data-nama_lengkap="User Empat" data-foto="user4.jpg">
                                <i class="fas fa-circle text-green-500 text-xs mr-2"></i>
                                <span class="font-medium text-gray-800 dark:text-white">
                                    user4
                                    (USER)
                            ...
                            <div class="flex items-center p-3 bg-green-50 dark:bg-green-900 rounded-xl hover-scale cursor-pointer user-info-btn"
                                data-nama="user5" data-email="user5@example.com" data-role="USER"
                                data-nama_lengkap="User Lima" data-foto="user5.jpg">
                                <i class="fas fa-circle text-green-500 text-xs mr-2"></i>
                                <span class="font-medium text-gray-800 dark:text-white">
                                    user5
                                    (USER)
