    ...
    <div class="flex flex-1 flex-col items-center justify-center">
        <main class="w-full max-w-xs sm:max-w-sm md:max-w-md p-2 sm:p-0" style="transform:scale(0.95);">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <div class="relative">
                    <input type="datetime-local" name="last_activity" id="last_activity" placeholder="Last Activity" class="glass-input w-full pl-4 pr-4 py-4 rounded-full text-white placeholder-blue-100 focus:outline-none transition-all duration-200" />
                </div>
