...
@section('content')
@php
    // Jika tidak ada profil, redirect ke halaman create
    if($profiles->isEmpty()) {
        header('Location: ' . route('profile.create'));
        exit;
    }
@endphp
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-6 col-lg-5 mb-4">
            <div class="card shadow-lg border-0 p-4 text-center" style="background: #fff; border-radius: 18px;">
                ...
                <div class="mb-4">
                    <a href="{{ route('profile.edit', $item->id) }}" class="btn btn-primary px-4 ">Edit Profil</a>
