...
Route::get('login', [App\Http\Controllers\AuthController::class, 'auth.ashowLoginForm'])->name('login');
Route::post('login', [App\Http\Controllers\AuthController::class, 'auth.login']);
Route::get('register', [App\Http\Controllers\AuthController::class, 'auth.showRegisterForm'])->name('register');
Route::post('register', [App\Http\Controllers\AuthController::class, 'auth.register']);
Route::post('logout', [App\Http\Controllers\AuthController::class, 'alogout'])->name('logout');
